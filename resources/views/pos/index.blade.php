    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="orderCompleteModalLabel">Order Completed</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="text-center mb-4">
                    <i class="fas fa-check-circle text-success fa-4x mb-3"></i>
                    <h4>Order has been completed successfully!</h4>
                    <p class="mb-1">Order #: <span id="order-number"></span></p>
                    <p class="mb-1">Total: <span id="order-total"></span></p>
                    <p class="mb-3">Payment Method: <span id="payment-method"></span></p>
                </div>
        ...
        $('#checkout-btn').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#payment-method').text(selectedPaymentMethod.charAt(0).toUpperCase() + selectedPaymentMethod.slice(1));
