                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="available">Product Availability</label>
                            </div>
                            <small class="form-text text-muted">Toggle to manually control product availability regardless of stock level</small>
                        </div>
